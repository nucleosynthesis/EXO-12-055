...
For the scalar and pseudoscalar models, $g_{\rm q}=1$ is assumed for all quark flavours, which implies 
...
MVA output distribution for V-tagged events in simulation and data after signal selection for 
(a) $\pt < 160$\GeV and (b) $\pt > 160$\GeV. At a $\pt$ of about 160\GeV, 
the jets from the V-boson decay begin to overlap. The dashed red line shows the expected distribution 
...
vector mediated DM production assuming $\m_{\mathrm{DM}}=$10\GeV and $m_{\mathrm{MED}}=$1\TeV is overlaid.  
...
%axial vector mediator model, 

%For vector and scalar mediator
%models, DD limits are stronger than those obtained in this
%analysis except for  $m_{\mathrm{DM}}<$6\GeV. 
...
%for $m_{\rm{DM}}<4$\GeV as shown in .  
