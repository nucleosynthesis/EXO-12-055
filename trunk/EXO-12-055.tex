...
\includegraphics[width=0.45\textwidth]{figures/post_fit_photon_boosted.pdf}
\includegraphics[width=0.45\textwidth]{figures/post_fit_zmm_boosted.pdf}\\
\includegraphics[width=0.45\textwidth]{figures/post_fit_wmn_boosted.pdf}\\
...
\begin{figure*}[hbtp]\begin{center}
\includegraphics[width=0.45\textwidth]{figures/post_fit_photon_resolved.pdf}
\includegraphics[width=0.45\textwidth]{figures/post_fit_zmm_resolved.pdf}\\
\includegraphics[width=0.45\textwidth]{figures/post_fit_wmn_resolved.pdf}
\end{center} \caption{Expected and observed fake \ETm distributions in the
photon~(\cmsLeft), dimuon (middle) and single-muon~(\cmsRight) control regions
...
\begin{figure*}[hbtp]\begin{center}
\includegraphics[width=0.45\textwidth]{figures/post_fit_photon_monojet.pdf}
\includegraphics[width=0.45\textwidth]{figures/post_fit_zmm_monojet.pdf}\\
\includegraphics[width=0.45\textwidth]{figures/post_fit_wmn_monojet.pdf}
\end{center} \caption{Expected and observed fake \ETm distributions in the
photon~(\cmsLeft), dimuon (middle) and single-muon~(\cmsRight) control regions
