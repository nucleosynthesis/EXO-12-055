...
interactions and $v=246$\GeV is the Higgs potential vaccum expectation value. 
...
account for the additional contributions which arise~\cite{Harris:2014hga}.
...
contain a b-tagged jet, defined using an MVA disciminator that uses secondary
...
referred to as pseudo-\ETm. The distribution of pseudo-$\ETm$ in 
...
the spin-independent (SI) or spin-dependent (SD) (for vector and scalar or axial vector) DM-nucleon
