...
after the fit to the data in the control regions, for each of the three signal regions, are given in 
...
are dominant for mediator masses up to $300$\GeV.
...
stronger than those from Fermi LAT for $m_{\mathrm{DM}}<100$\GeV.
