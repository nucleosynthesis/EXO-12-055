...
\abstract{
A search is presented for an excess of events with a large missing transverse energy in association with a highly energetic jet in a data sample of proton-proton 
interactions at centre-of-mass energy of 8 TeV. The data correspond to an integrated luminosity of 19.7 $\textrm{fb}^{-1}$ collected by the CMS detector at the LHC. 
The results are interpreted under a set of simplified models describing the production of dark matter via a new scalar,
...
pp collisions at the Large Hadron Collider (LHC) at a
...
techniques designed to exploit information available in jet substructure of.  
...
distribution in each event category, providing improved
sensitivity compared to the previous CMS monojet analysis~\cite{monojet1}. 

This paper is structured as follows: Section 2 outlines the DM models
explored as signal hypotheses; Section 3 provides a description of the
...
extraction; Section 5 presents the results and interpretations in  
...
couplings $g_{\mathrm{DM}}$ and $g_{\mathrm{SM}}$ denotes the coupling of the mediator to the Dark
Matter particle and to standard model particles respectively~\cite{Harris:2014hga}.  
...
thus have limited sensitivity from the direct detection experiments~\cite{Haisch:2012kf}.  
...
In order to model the expected contribution from these signals, simulation  
...
PYTHIA6~\cite{Sjostrand:2006za} for parton showers and GEANT4~\cite{geant4} for simulation of the CMS detector.  
For the monojet signal, the generation is performed using the mediator mass for both the generation and shower scale. 
The impact of this choice was found to be up to 30\% in the expected signal yield in the relevant kinematic region 
for mediator masses above 400 GeV. 
...
\label{fig:monojet1} } 
\caption{Diagrams for production of DM via a scalar mediator providing (a) monojet and 
(b) mono-V signatures. (c) Diagram for production of DM via a vector mediator.\label{fig:monoXfeyn}} \end{figure}
...
algorithm~\cite{CMS-PAS-PFT-09-001} together with a jet of \pt$>80$ \gev and
$|\eta|<2.6$. The lowest threshold on \ETm for event selection is set at 200 GeV 
...
are corrected for pileup on the basis of the observed event energy density. 
...
$\pt>10$~\gev, or a tau with $\pt>15$~\gev. The electon, tau and photon vetoes require that the  
...
This results in three othogonal categories of events which are referred to as monojet, V-boosted,  
and V-resolved.
...
sample, produced with POWHEG~\cite{powheg,Alioli:2009je}, and a set of diboson samples,
...
cutting on ``subjettiness'' quantity $\tau_2/\tau_1$ as defined 
...
radiation yields additional jets. If an ak5 jet with $\pt>30$ and $|\eta|<2.5$
...
modelling between data and simulation resulting form imperfect knowledge of the 
parton shower and detector modelling. 
...
the combinatorial background in the V-resolved category, a multivariate (MVA) variable 
selection is applied. The inputs to the MVA are the likelihood-based discriminators which distinguish 
...
contains a b-tagged jet, defined using an MVA containing secondary vertex information  (CSV
...
binned likelihood fit is performed in the range 250-1000 \gev (200-1000 \gev 
...
from dimuon and photon (single-muon) control regions. The dimuon control regions is defined 
...
$|\eta|<2.5$, excluding photons in the ECAL transition region, $1.44 < |\eta|< 1.56$. 

For estimating the $\Wlvjets$ background, a single-muon control region is defined by selecting events 
...
      350 - 400 & 79  &     62.1$\pm$11.7  &      0.3$\pm$0.0  &      5.5$\pm$0.7  &      0.5$\pm$0.2  &     21.5$\pm$8.9  &      3.2$\pm$0.3  &     31.1$\pm$7.0  \\ 

      400 - 450 & 20  &     38.3$\pm$10.5  &      0.1$\pm$0.0  &      1.5$\pm$0.2  &      1.5$\pm$0.7  &     14.5$\pm$8.5  &      0.6$\pm$0.3  &     20.1$\pm$6.4  \\ 

      450 - 500 & 16  &      8.5$\pm$3.6  &      0.0$\pm$0.0  &      1.0$\pm$0.4  &      0.0$\pm$0.0  &      1.0$\pm$2.6  &      0.4$\pm$0.1  &      6.1$\pm$2.7  \\ 
...
\bigskip
	...
	$E_{T}^{miss} bin (GeV)$ & Observed  & Total Bkg  & Z($\rightarrow ll$)+jets & top & QCD & W($\rightarrow l\nu$)+jets & Dibosons &  Z($\rightarrow \nu\nu$)+jets \\
\hline 
     250 - 300 & 1073  &   1103.0$\pm$63.4  &      2.5$\pm$0.0  &     35.4$\pm$3.7  &      0.0$\pm$0.0  &    278.8$\pm$32.5  &    103.2$\pm$14.6  &    682.5$\pm$40.1  \\ 

      300 - 350 & 453  &    445.7$\pm$33.9  &      0.7$\pm$0.0  &     12.7$\pm$1.3  &      0.0$\pm$0.0  &    114.3$\pm$19.6  &     46.5$\pm$6.9  &    271.4$\pm$22.8  \\ 

      350 - 400 & 160  &    184.0$\pm$18.1  &      0.2$\pm$0.0  &      5.6$\pm$1.0  &      0.0$\pm$0.0  &     38.3$\pm$8.7  &     22.2$\pm$3.3  &    117.4$\pm$12.8  \\ 

      400 - 450 & 81  &     72.1$\pm$28.9  &      0.0$\pm$0.0  &      1.5$\pm$0.8  &      0.0$\pm$0.0  &      9.8$\pm$3.4  &     11.0$\pm$1.8  &     49.7$\pm$7.3  \\ 

      450 - 500 & 30  &     44.3$\pm$6.6  &      0.0$\pm$0.0  &      0.5$\pm$0.1  &      0.0$\pm$0.0  &      5.0$\pm$2.6  &      7.4$\pm$1.1  &     31.2$\pm$6.1  \\ 

      500 - 1000 & 39  &     54.3$\pm$8.5  &      0.0$\pm$0.0  &      0.2$\pm$0.0  &      0.0$\pm$0.0  &      6.4$\pm$3.4  &      7.8$\pm$1.1  &     39.8$\pm$7.8  \\ 
\hline 
    \end{tabular}
  \end{center}
\end{sidewaystable}
...
A simultaneous fit was performed to the signal region across the three event categories,
...
(Fig.~\ref{fig:post_fit_plots}) and another setting the expected total yield of
...
LUX~\cite{Akerib:2012ys} which currently
...
combination of the V-tag categories categories is
...
high energy jet in association with a large missing transverse energy in a
...
detector at the LHC.  This search is the first at CMS to utilize sub-structure
