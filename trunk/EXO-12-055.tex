...
couplings $g_{\mathrm{DM}}$ and $g_{\mathrm{SM}}$ denote the coupling
...
Pseudoscalar mediated interactions are velocity suppressed in DM-nucleon interactions and
...
be performed by allowing the scalar and pseudoscalar mediated interactions to undergo
...
The excess observed in FermiLAT data has led to speculations that DM
