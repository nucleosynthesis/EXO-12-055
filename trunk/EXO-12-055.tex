...
techniques designed to exploit information available in jet substructure.  
...
An alternative choice taking $\sqrt{\pt_{\textrm{MED}^{2}+m_{\textrm{MED}}^{2}}}$ for the hadronisation scale was found to result in differences of up to 
80\% in the expected signal yield in the relevant kinematic region for mediator masses above 400 GeV. 
...
when summed in quadrature.  Electroweak corrections are not accounted for in
...
from Fermi LAT~\cite{Ackermann:2011wa,Abdo:2010ex}.  These limits apply to the
