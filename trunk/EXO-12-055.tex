...
thus direct detection experiments have limited sensitivity to such experiments~\cite{Haisch:2012kf}.  
...
The impact of this choice was found to be up to 30-80\% in the expected signal yield in the relevant kinematic region 
for mediator masses above 400 GeV when compared with using the boson
\pt for the shower scale. 
...
identified object be isolated using default PF isolation algorithms
for each object~\cite{Beaudette:2014cea}.
...
The discrepancy between data and simulation is covered by systematic
uncertainties (not shown) that are determined in the V-boson enhanced
di-top control region~\cite{Khachatryan:2014vla}. The dashed red line shows the expected distribution for scalar-mediated DM production with 
...
The MVA distribution for V-tag events in simulation and data after
full signal selection for (a) $\pt < 160$ GeV and (b) $\pt > 160$ GeV. At a $\pt$ of about 160 GeV, 
...
uncertainties. The scale uncertainties for both the renormalization
...
production cross-sections in the requested phase space of the analysis. These individual backgrounds have been studied
