...
improvement can be derived by adding control regions, regions which are orthogonal to the 
signal with negligible contributions expected from signal, to simultaneously
