...
\RCS$Id: EXO-12-055.tex 306843 2015-10-26 08:39:08Z nckw $
%%%%%%%%%%%%% local definitions %%%%%%%%%%%%%%%%%%%%%
...
pseudoscalar, vector, or axial mediator. 
}
...
\maketitle %maketitle comes after all the front information has been supplie
% >> Text
\input{intro}
\input{cms}
